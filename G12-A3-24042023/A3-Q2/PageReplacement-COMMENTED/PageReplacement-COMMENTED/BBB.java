...
public class BBB extends ReplacementAlgorithm
{
	...
	//frameList is an object of the inner class BBBList
	private BBBList frameList;

	// This is the constructor of the class BBB that creates an object of the inner class BBBList and sets the page frame count
	...
	class BBBList
	{
		...
		// This method prints the pageFrameList and the elementCount
		void dump() {
